...
CREATE TABLE `r_category` (
  ...
  `level` tinyint unsigned NOT NULL DEFAULT '1' COMMENT '层级，顶级=1',
  ...
  `url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '绝对URL',
  `href` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '链接',
  `created_at` datetime NOT NULL COMMENT '创建时间',
  `updated_at` datetime NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `r_drama` (
  ...
  `title` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '剧名称',
  `desc` varchar(180) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '简介',
  ...
  `cover` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '封面图',
  `score` decimal(10,1) unsigned NOT NULL DEFAULT '0.0' COMMENT '豆瓣评分',
  `hot` int NOT NULL DEFAULT '0' COMMENT '最热',
  `douban_film_review` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '豆瓣影评',
  `douyin_film_review` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '抖音影评',
  `xinlang_film_review` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '新浪影评',
  `kuaishou_film_review` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '快手影评',
  `baidu_film_review` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '百度影评',
  `site` varchar(50) NOT NULL COMMENT '站点',
  `url` varchar(120) NOT NULL COMMENT '绝对URL',
  `href` varchar(120) NOT NULL COMMENT '链接',
  `created_at` datetime NOT NULL COMMENT '创建时间',
  `updated_at` datetime NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `idx_title` (`title`),
...
CREATE TABLE `r_drama_episode` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT '集ID',
  ...
  `total_episodes` int unsigned NOT NULL DEFAULT '0' COMMENT '总集数',
  `episode_number` int unsigned NOT NULL DEFAULT '0' COMMENT '集序号',
  `episode_name` char(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '集名称',
  `play_url` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '播放URL',
  `site` varchar(50) NOT NULL COMMENT '站点',
  `url` varchar(120) NOT NULL COMMENT '绝对URL',
  `href` varchar(120) NOT NULL COMMENT '链接',
  `created_at` datetime NOT NULL COMMENT '创建时间',
...
CREATE TABLE `r_tag` (
  ...
  `is_hot` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '热门标签: 1-是 0-否',
